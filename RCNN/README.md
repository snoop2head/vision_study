...
### 0. TF, Pytorch Implementation for CNN
...
### 1. [Kaggle Dog Breeds Detection: Stanford Dog Dataset](https://www.kaggle.com/kaggleslayer/simple-convolutional-n-network-with-tensorflow)
...
### 4. Kaggle Wheat Detection with FasterRCNN using Pytorch
